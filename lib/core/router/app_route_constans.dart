class AppRouteConstants {
  ...
  static const String registerUserRouteName = '/register';
  static const String dashboardAdminRouteName = '/dashboard-admin';
  static const String wasteTypeRouteName = '/waste-type';
